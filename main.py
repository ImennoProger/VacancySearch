...
plants = [
    ...
    {"name": "Бадан", "color": "розовый", "size": "маленький", "type": "цветок", "link": "https://elovpark.ru/product/%d0%b1%d0%b0%d0%b4%d0%b0%d0%bd-%d1%82%d0%be%d0%bb%d1%81%d1%82%d0%be%d0%bb%d0%b8%d0%b8%d1%81%d1%82%d0%bd%d1%8b%d0%b9/"},
...
class PlantEngine(KnowledgeEngine):
    ...
    def add_facts(self):
        ...
        for plant in plants:
            # Добавляем только растения, соответствующие запросу
